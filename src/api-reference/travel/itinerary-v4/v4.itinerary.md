...
* Events are only raised on a go-forward basis. If you need access to historical data, refer to [Retrieve Trips](#retrieve-trips).
...
## Retrieve Trips Schema <a name="schema"></a>
